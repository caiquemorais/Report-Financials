Este relatório, criado a partir do dataset "Financial Sample" para o Bootcamp Python Data Analytics, é um dashboard interativo que fornece uma visão detalhada das vendas.
